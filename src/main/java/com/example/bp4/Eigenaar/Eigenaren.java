...
public class Eigenaren {
    ...
    public Eigenaren(String eigenaar_voornaam, String eigenaar_achternaam, String woonplaats, String telefoonnummer, String emailadres, String wachtwoord, boolean verified) {
    ...
    public Eigenaren(int id, boolean verified) {
        this.eigenaar_id = id;
        this.verified = verified;
